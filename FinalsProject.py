...
MAGE_ICON_URL = "https://www.kindpng.com/imgv/howhmi_clip-art-marketing-icon-drip-room-hd-png/"
st.set_page_config(layout="centered",page_icon=MAGE_ICON_URL)

st.title("Finding Correlation(s) in the Marketing Campaign Data")
st.write("Grace Lee; Math 10")
